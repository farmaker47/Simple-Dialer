...
import com.simplemobiletools.dialer.activities.MainActivity.Companion.AVERAGE_WINDOW_DURATION_MS
import com.simplemobiletools.dialer.activities.MainActivity.Companion.DETECTION_THRESHOLD
import com.simplemobiletools.dialer.activities.MainActivity.Companion.LABEL_FILENAME
import com.simplemobiletools.dialer.activities.MainActivity.Companion.MINIMUM_COUNT
import com.simplemobiletools.dialer.activities.MainActivity.Companion.MINIMUM_TIME_BETWEEN_SAMPLES_MS
import com.simplemobiletools.dialer.activities.MainActivity.Companion.SUPPRESSION_MS
import java.io.BufferedReader
import java.io.InputStreamReader
import java.util.*
import com.simplemobiletools.dialer.helpers.RecognizeCommands.ScoreForSorting as ScoreForSorting1
...
class RecognizeCommands(contxt: Context) {
    ...
    private val averageWindowDurationMs: Long = AVERAGE_WINDOW_DURATION_MS
    private val detectionThreshold = DETECTION_THRESHOLD
    private val suppressionMs = SUPPRESSION_MS
    private val minimumCount = MINIMUM_COUNT
    private val minimumTimeBetweenSamplesMs: Long = MINIMUM_TIME_BETWEEN_SAMPLES_MS
